...
public class Ppal {
	...
	//	Tablero t = new Tablero();
		...
		for (int i = 0; i < listaJugadores.length; i++) {
			...
			listaJugadores[i] = new Jugador(nombre, dinero, posicion, player, posAnterior); //Creo que si los datos se los vamos a pasar luego de çbemos crear los jugadores vacios y luego se rellenan
			player++;
		}
